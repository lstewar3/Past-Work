...
### phone and name, (note that you can change these to other variablest that are listed in the API library) provide this information 
### as relates to the location querried 
