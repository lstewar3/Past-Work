...
#(2) Once you have selected your data set. Open the script below in an r script and hit ctrl+F. This will start the search prompt. Search for Insert_Data_Set_Name and replace it with the name of your chosen dataset.
...
#(3) You may now run the code with the selected data set. 
