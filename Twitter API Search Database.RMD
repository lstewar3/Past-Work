...
###Introduction
This R Markdown explains how I built My Twitter API Search Tool and SQL Database. This document will explain the following; 
...
###(1) Install Packages and prepare workspace 
```{R}
...
###(2) Create and connect to your MySQL database and use R to send tweets from a query to the databse for further analysis. 
```{r}
